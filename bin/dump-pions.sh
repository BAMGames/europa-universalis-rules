...
# Reporter 1000-x1+x0
# Pour Y, 744-y1+y0
XCROP="777 546 544 84"
YCROP="470 188 642 360"
DELAY=5
...
pnmcut -left 8 -right -8 -top 8 -bottom -8 < ${DIRECTORY}/page-${ZOOM}-${pp}.pnm | pnmcrop -white  > ${DIRECTORY}/new.pnm
mv ${DIRECTORY}/new.pnm ${DIRECTORY}/page-${ZOOM}-${pp}.pnm
p=$((p+1))
done
if [ "$NOCAP" != "1" ]; then
