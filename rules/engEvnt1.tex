% -*- mode: LaTeX; -*-
\definechapterbackground{Political Events of Period I}{scenarios}
...
\begin{eventstable}[Period I events table]
  ...
  \begin{tabular}{|l|*{5}{c}|l|}
    ...
    1 & 1  & R2 & 3   & R15 & R16 & \\
    2 & 1  & 3  & R11 & R14 & 3   & \textbullet~1--2 \\
    3 & 1  & 10 & R12 & 4   & R11 &  +1 then \\
    4 & 3  & 12 & R4  & 7   & R15 & \periodref{II} \\
    5 & 5  & 13 & R8  & 11  & R4  & \\
    6 & R6 & 4  & R4  & R6  & R8  & \\
    7 & R2 & R6 & R5  & R8  & R3  & \textbullet~3--10: \\
    8 & 7  & 9  & 8   & 9   & R16 & \periodref{II} \\
    9 & 11 & 13 & 3   & 10  & R7  & \\\hline
    10 & \multicolumn{5}{l}{Roll in \periodref{II}} & \\\hline
  \end{tabular}
\end{eventstable}
...
\seazone{Tempetes} and \seazone{Aiguilles}.
...
% LocalWords: Ryazan Barbaros RistoMod Minas Gerais Tempetes
...
% LocalWords: Duche Prusse Livonian Aiguilles
