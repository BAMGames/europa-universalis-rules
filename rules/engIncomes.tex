...
See~\ruleref{chPeace:TradeCentres} for details.
...
%%\aparag See~\ruleref{chPeace:TradeCentres} for the displacement of the
%%centre.
...
\bparag See~\ref{chPeace:CorsairAttack} for details.
...
see~\ruleref{chPeace:InflationGoldROTW}.
...
\ruleref{chPeace:GoldRepatriation}) (or both).
