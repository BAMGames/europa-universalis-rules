...
number of \TradeFLEET levels in \stz{Tempetes}, \stz{Arabie}, \stz{Indien} and
\stz{Chine}.
...
be permanently exterminated). It replenishes if it was reduced but some
natives are still alive.
