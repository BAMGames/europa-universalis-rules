...
\definechapterbackground{Exchequer test and budget}{Exchequer}
...
\begin{playtip}
  ...
  in \lignebudget{Gross income A} for the turns where they affect the
  Exchequer test.
\end{playtip}
...
\lignebudget{Remaining expenses} (if positive).
\bparag This must be 0 in case \lignebudget{Remaining expenses} is 0 or less
...
\aparag[International Loans]\label{chBudget:Budget:I. Loans}
 Write in \lignebudget{from I. loan} any
...
\begin{exemple}[Multiple international loans]
...
\begin{playtip}
  ...
  Note also that the malus to the Exchequer test is for loans still going on
  ...
  you're left with 199\ducats of loan before the test, thus only a \bonus{-1}
  ...
  \bonus{-1} DRM can be an extremely good idea.
\end{playtip}

\begin{exemple}[Planning your budget]
  If your \STAB is +2 and you are at peace (\bonus{+2} to Exchequer test),
...
\lignebudget{Stability improvement}. As for administrative actions, higher
