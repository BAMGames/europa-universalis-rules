...
\subsection{Activation of natives}
\begin{todo}
  TODO!
\end{todo}
...
natives after an exploration), each of its values is halved (rounded down).
...
loses if the loses are more than the number of first line ships.
