...
moving, or exiting an unfriendly province can be done as a passive
move.
...
\begin{exemple}
  ...
  there are 4\LD that resist and fight.

  Note that due to the way the table is read, 'R30/D80' actually means that
  there is 100-80=20\% of the stack that desert and 100-30=70\% that resist.
\end{exemple}
