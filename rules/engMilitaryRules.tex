...
\bparag \xnameref{chMilitary:Battle:Fight}: each battle can last up to 2
  \terme{days}. Each day is further split in a \terme{fire} and a
  \terme{shock} (or \terme{boarding} at sea) roll.
...
Note that since Northern Forest are necessarily Dense Forest and \SUE is of
class \CAIIIM, the specific \SUE bonus is actually only effective during
periods \period{III} and \period{VI}.
