...
\begin{exemple}[Undermining]
  ...
  In period \period{III}, \FRA has 3 artillery per \ARMY\faceplus, hence only
  1 per \ARMY\facemoins. Its stack of 6\LD (\ARMY\faceplus, \ARMY\facemoins)
  thus has 4 artillery. That gives an \terme{Artillery bonus} of only
  \bonus{+1}. Neither \FRA nor \HIS has a leader with a siege value. Thus, the
