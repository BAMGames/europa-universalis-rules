...
\begin{exemple}[From an actual gaming session]
  ...
  However, the only retreat possibility for \pays{royalistes} is the fortress
  of \ville{Plymouth} which can only accommodate 1\LD. Thus, the actual losses
  suffered by \pays{royalistes} are actually 7\LD (8 initial - 1 who managed
  to retreat). Note that in this particular case, there is actually no need to
