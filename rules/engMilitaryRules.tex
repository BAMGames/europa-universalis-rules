...
\begin{exemple}[Assault]
  ...
  Nobody routs. The fortress suffered only \texttd and hold. \FRA suffered
...
\begin{exemple}[Variations on assault]
  ...
  much better! The same rols for \FRA gives 8+2=10 for Fire
  ...
  \terme{Breach} columns and only causes 0+\texttd=\texttd losses.
  ...
  3\textetoile\textetoile\textetoile\textetoile. Whether the fortree falls
