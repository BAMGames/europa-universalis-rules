...
there is always only one stack moving, first it is solely naval, then it is
a combined land and naval stack and finally it is solely land. A naval stack
may not embark troops if it has already been engaged in a battle this round
...
interception and resulting battle.
...
counter may stay inside ships at the end of movement and even from one impulse
