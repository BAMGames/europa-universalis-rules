...
chooses which; if it is too small to undermine, it may not fight the
...
it, or \terme{Redeploy}. In order to undermine, a stack must have at least as
many \LD as the level of the fortress. Besieging stacks must do one (and only
one) of the three actions listed above. It is not possible to do nothing.
...
undermine. A too small stack that redeploys rolls twice for \terme{Attrition}
(one \terme{Siege Attrition} because it is too small and one \terme{Movement
  Attrition} because of the redeployment).
