...
counter, then any province with no enemy presence (activated natives, enemy
troops, enemy city or establishment (even besieged), \ldots) is considered to
contain a controlled port (not arsenal) (both for embarking and disembarking).
...
and does not counted toward any campaign cost. Any exceeding troops after that
...
\terme{Redeployments} (even if the stack fas a LoS and is large enough to
