...
\aparag[Cavalry modifiers.] During any land battle, any stack gain a 0/+1 DRM
...
\begin{exemple}[Battle parameters]
  ...
  in period \period{III}. Anyway, \FRA has 3 more \LD than \HIS and thus still
  gets the \bonus{+1} cavalry bonus (which can only be obtained once).
  ...
  on par with the Spanish ones. Don't forget to grab all those \bonus{+1}, in
  the end they will save the day\ldots
\end{exemple}
