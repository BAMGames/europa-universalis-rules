...
soldiers, depending on the country and the period.
...
\begin{exemple}[Minor reinforcements]
  ...
  \LeaderG for \paysAlgerie (among the grey \anonyme\LeaderG). Then, \TUR
  raise the fortress of \provinceAlgerie to level 2. As for the troops, \TUR
  chooses to take 2\NGD instead of 1\ND and put them directly in the \FLEET
  (and note on its record sheet the exact content of the Algerian \FLEET). The
  \LD is put in \provinceAlgerie, waiting to board for an invasion of
  Spain\ldots
\end{exemple}
...
leaders as necessary to reach the minimal value.
