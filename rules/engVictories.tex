...
\begin{designnote}
  ...
  game hardly qualifies as a ``Victory''. It is not only within the error of
  margin of the system but also between the margin of counting error during
  the game.

  Thus, \VPs should be more considered as a guideline at what actions should
  ...
  So, any action that is rewarded (or punished) by 50\VPs should be considered
  as something extremely important and a huge goal to achieve for the
  players. A 10\VPs bonus is more of a secondary objective, or a penalty that
  may be payed once or twice.
\end{designnote}

\begin{designnote}
  All in all, players are expected to gain around 2000-2500\VPs along the
  game. The end of period check should be around 100\VPs, more for countries
  in their period of Glory, less for decaying countries. The period objectives
  should be around 100-200 \VPs depending on your success on the field.
\end{designnote}
...
\aparag The \VP system is composed of 4 parts.
\bparag {\VPs per turn: }
Those \VPs are earned by players performing special actions and
discoveries. It corresponds approximately to the quarter of the final \VPs.
...
\aparag Note that some other actions (\emph{e.g.} Bankruptcy, some events,
\ldots) may also give or take \VPs during turn and are not all recalled
here.
...
\terme{Monopolies} are defined for exploitation of each exotics resources
...
country has a partial \terme{monopoly} if it produces at least 6 units and
half of the world production of this resource. It has a total \terme{monopoly}
if it produces all units but 2 of this resource.
...
\aparag[Discoveries] 
\bparag Discoveries \VPs or \Areas are given to the first country who
...
stack carrying it must have cross Cape Horn.
