...
\subsection{\sectionpaysmajeur{Portugal}}
\aparag[Territory.]
...
\subsection{\sectionpaysmajeur{Venise}}
\aparag[Territory.]
...
\subsection{\sectionpaysmajeur{Pologne}}
\aparag[\region{Duche de Prusse}.] {\it Provinces of \region{Duche de
    Prusse} that \paysmajeur{Pologne} voluntarily gave to
  \pays{brandebourg} are counted as if \paysmajeur{Pologne} still
  control them.}

\aparag[Territory.]
\bparag 4 times the income value of each non-national province (Ukrainyan
...
\subsection{\sectionpaysmajeur{Hollande}}
...
\aparag[Military.]
\bparag 30 \VPs: First or second largest fleet.
\bparag 15 \VPs: At least 15 \NWD (not compatible with the precedent).

\subsection{\sectionpaysmajeur{Angleterre}}
\aparag[Territory]
...
\subsection{\sectionpaysmajeur{France}}
\aparag[Territory.]
...
\subsection{\sectionpaysmajeur{Espagne}}
\aparag[Territory.]
...
\subsection{\sectionpaysmajeur{Autriche}}
\aparag[Territory.]
...
\subsection{\sectionpaysmajeur{Russie}}
\aparag[Territory.]
...
\aparag[Development.]
\bparag 30 \VPs: construction of \ville{Saint-Petersbourg}.

\subsection{\sectionpaysmajeur{Turquie}}
\aparag[Territory.]
...
\subsection{\sectionpaysmajeur{Prusse}}
\aparag[Territory.]
...
\subsection{\sectionpaysmajeur{Suede}}
%\bparag ({\it divide total by 2 if it is a Transfer check})
\aparag[Territory.]
