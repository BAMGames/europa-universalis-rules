...
\aparag [5 \VPs for each \COL or \TP] in the specified area (and/or
periods)
...
\aparag[Income value of each province annexed during the period]
...
\aparag[6 \VPs] for each minor countrie in {\bf \VASSAL or \ANNEXION} (or
