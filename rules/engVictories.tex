...
\bparag Note that \provinceKuban may count both as a Georgian and
Crimean province and thus bring \VPs for both reasons.
% (jym) Adding Zeeland to it makes way more sense.
% Note that \provinceZeeland is
