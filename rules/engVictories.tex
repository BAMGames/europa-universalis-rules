...
minor country (\paysHongrie, \paysPerse, \paysGeorgie), it consists in
all the provinces barring the corresponding solid or blurred shield, and
owned by the country in 1492, whatever their current owner (especially
if the country was destroyed).
...
\begin{exemple}
  ...
  a \blasonsmall{georgie} or \blasonsmall{perse} counts, even if it was
  annexed from, typically, \TUR.
\end{exemple}
