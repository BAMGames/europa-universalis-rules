...
\aparag[Commercial monopoly.] When objectives ask for Monopoly in \STZ
...
\aparag[Independence wars.] \ref{pVII:Independence War} may occur
...
\aparag[Hungary.] When an objective refers to \paysHongrie or its
provinces, it consists in all the provinces that are owned by
\paysHongrie in 1492, whatever their current owner (especially if
\paysHongrie was destroyed).
\bparag These provinces all have a non-blurred Hungarian shield.
\bparag List of Hungarian provinces: \provinceMures, \provinceErdely,
\provinceBukovina, \provinceKarpatok, \provinceSzlovakia,
\provinceBalaton, \provinceCarniola, \provinceKapela, \provinceCroatie,
\provincePecs, \provinceMagyarorszag, \provinceBanat.
