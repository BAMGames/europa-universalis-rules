...
provinces, it consists in all the provinces with a \blasonsmall{hongrie}
shield, that are owned by \paysHongrie in 1492, whatever their current
owner (especially if \paysHongrie was destroyed).
