...
\bparag convoy of \bazar{Izmir};
\bparag \dipAT with \paysaden, \paysoman or \paysgujarat; 
\bparag total income of each \COL/\TP producing at least one unit of
\RES{PO}, \RES{Spice} or \RES{Silk};
\bparag \TradeFLEET in any \CTZ of the \CCs{Tempete}.
...
\paysMoldavie, \paysNaples, \paysPerse, \paysprovincesne,
...
\bparag List of Valachian provinces (\blasonsmall{valachie}):
\provinceValahia.
