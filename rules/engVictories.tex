...
\begin{exemple}
  ...
  4978\ducats (\lignebudget{Period wealth} at turn 25). Period \period{III}
  is 11 turns long and \TUR percentage is 20\% in this period. Hence \TUR
  scores $4978 / 11 \times 0.20 = 90.5$ rounded down to 90 Wealth and Prestige
  \VPs.

  At the same time, \VEN has 6012\ducats of Wealth, with 26\ducats in \RT but
  ...
  its Prestige and Wealth \VPs are $(6012 + 26 - 2 \times 148) / 11 \times
  0.25 = 130.5$ rounded down to 130\VPs.
\end{exemple}
...
\begin{designnote}
  If \ANG or \FRA has \COL in \granderegionOceania in \period{V}, they do not
  earn any \VPs for these. They will only bring \VPs in period
  ...
  by the expeditions of \leaderCook, \leaderBougainville or \leader{La
    perouse} and thus were only known to European in the very late game and
  colonised in the 19th Century.

  Similarly, French \COL in \continentIndia only earns \VPs in the end game
  while English \COL there start earning \VPs in period n\period{IV}. This
  represent the different colonial policies (and power) of these countries and
  the early start of \ANG in \continentIndia (with the East India Company)
...
\begin{designnote}
  ...
  and only tried to grab part of the Burgundian legacy after its Wars of
  Religion, with the policies of Richelieu and Louis XIV, the ``pré carré'' of
  Vauban and such.
\end{designnote}
...
each player must secretly pick 3 of the possible 5 objectives for its country.
...
this. A \VP value is indicated in the tables for each objectives. If a player
choose an objective and complete it, he earn its \VP value, if it is the
\textbf{main objective}, he earn twice this value.
\bparag Some objectives are marked on the tables with {\bf M}, they are
objectives with malus, if a player both don't pick up this objective, and
don't complete it, he loses the associated \VPs.
