...
\begin{designnote}
  ...
  the game (are you sure you did not forget a 1 \VP discovery at some point in
  the game?)
...
\begin{designnote}
  ...
  game. The end of period check should be around 100 \VPs per period, more for
  countries in their period of Glory, less for decaying countries. The period
  objectives should be around 100-200 \VPs per period depending on your
...
according to it. For player who change country mid-game, a Transfer check is
also computed.
