...
according to this.
\bparag A \VP value is indicated for each objective. If a player chooses an
objective and complete it, he earn its \VP value, if it is the \textbf{main
  objective}, he earn twice this value.
...
\aparag[Domination commercial in \STZ{Baltique}.]
Having Commercial Monopoly in \STZ{Baltique} (with no one levying
Taxes), or Levying Taxes on the Sund, or having diplomatic control of a
minor country having the Rights of Levies on the Sund (raising them or
not), see \ruleref{chSpecific:Sund Levies}.

\aparag[Dominium Marii Baltici.] (Swedish objective) Owning all
