...
objectives which depend on the occurence of an event.
...
\aparag[Commercial Domination in \stz{Baltique}.] Each turn, one country
may have Commercial Domination in \stz{Baltique}. Commercial Domination
...
\begin{history}
  ...
  preferred free trade. This result in several Dutch implications in the
  Northern war, often using its fleet to reinforce the Danish one.
\end{history}

\aparag[Dominium Marii Baltici.] (DMB) is Ownership of all
provinces bordering the \region{Baltique}, excepted for provinces
currently owned by \pays{Brandebourg} (or \PRU) or \pays{Danemark}.

\begin{designnote}
  This represents the Swedish expansion towards the Southern shore of
  the see. Including the many struggles with \POL, the will to destroy
  \paysHanse and the conflict with \RUS around \provinceIngria.
\end{designnote}
...
\bparag Thus, for example, the Mediterranean Trade Centre is, for \VPs
purposed, considered to be owned by the country with the greatest sum of
\emph{maximum} levels in the corresponding \CTZ/\STZ. Same goes for the
Atlantic and Indian Centres.
