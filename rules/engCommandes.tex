...
% Jym
\def\Xamiral{\includegraphics[height=0.8em]{amiral.pdf}}%
\def\Xconquistador{\includegraphics[height=0.8em]{conquistador.pdf}}%
\def\Xcorsaire{\includegraphics[height=0.8em]{corsaire.pdf}}%
\def\Xdoge{\includegraphics[height=0.8em]{doge.pdf}}%
\def\Xexplorateur{\includegraphics[height=0.8em]{explorateur.pdf}}%
\def\Xgeneral{\includegraphics[height=0.8em]{general.pdf}}%
\def\Xgouverneur{\includegraphics[height=0.8em]{gouverneur.pdf}}%
\def\Xingenieur{\includegraphics[height=0.8em]{ingenieur.pdf}}%
\def\Xmonarque{\includegraphics[height=0.8em]{monarque.pdf}}%
