...
\TUabbrevdef{VGD}{VG\bbold{D}} % Venetian Galeasses Detachments
...
\def\Man{\terme{Manoeuvre}\xspace}
\def\Fire{\terme{Fire}\xspace} % leader value
\def\Shock{\terme{Shock}\xspace} % leader value
\def\Boarding{\terme{Boarding}\xspace} % leader value
...
\newcommand{\hug}{\pays{Huguenots}\xspace} % FWR
\newcommand{\lig}{\pays{Ligue}\xspace} % FWR
...
% "alliance" being a game term is not a good name for something else.
\newcommand{\alliance}{\textsc{Union}\xspace} % TYW
% TODO \alliance -> \union
\newcommand{\ligue}{\textsc{League}\xspace} % TYW
...
\newcommand{\RevReb}{\REVOLT/\REBELLION}
...
\TUabbrevdef[SUPPLY]{\{Supplied\}}{\countermark{Supplied}}
\TUabbrevdef[ASSAULT]{\{Assault\}}{\countermark{Assault}}
\TUabbrevdef[BREACH]{\{Breach\}}{\countermark{Breach}}
...
\def\tu{\textonethird}
\def\td{\texttwothird}
\def\texttu{\textonethird\xspace}
\def\texttd{\texttwothird\xspace}

\def\TTER{\technologie{Tercios}\xspace}
\def\STTER{\technologie{TER}\xspace} % 'S'hort TTER
\def\TMED{\technologie{Medieval}\xspace}
\def\STMED{\technologie{MED}\xspace}
\def\TREN{\technologie{Renaissance}\xspace}
\def\STREN{\technologie{REN}\xspace}
\def\TARQ{\technologie{Arquebus}\xspace}
\def\STARQ{\technologie{ARQ}\xspace}
\def\TMUS{\technologie{Muskets}\xspace}
\def\STMUS{\technologie{MUS}\xspace}
\def\TBAR{\technologie{Baroque}\xspace}
\def\STBAR{\technologie{BAR}\xspace}
\def\TMAN{\technologie{Manoeuvre}\xspace}
\def\STMAN{\technologie{MAN}\xspace}
\def\TL{\technologie{Lace}\xspace}
\def\STL{\technologie{L}\xspace}

\def\TVGA{\technologie{Galleasses}\xspace}
\def\TGA{\technologie{Galley}\xspace}
\def\STGA{\technologie{GA}\xspace}
\def\TCAR{\technologie{Carrack}\xspace}
\def\STCAR{\technologie{CAR}\xspace}
\def\TGLN{\technologie{Nau-Galeon}\xspace} % Por: Nau / Esp: Nao
\def\STGLN{\technologie{Nau}\xspace}
\def\TGF{\technologie{Galleon-Fluyt}\xspace}
\def\STGF{\technologie{GAL}\xspace}
\def\TBAT{\technologie{Battery}\xspace}
\def\STBAT{\technologie{BAT}\xspace}
\def\TVE{\technologie{Vessel}\xspace}
\def\STVE{\technologie{VE}\xspace}
\def\TTD{\technologie{Three-decker}\xspace}
\def\STTD{\technologie{TD}\xspace}
\def\TSF{\technologie{74's guns}\xspace}
\def\STSF{\technologie{74s}\xspace}
...
\newcommand{\blason}[1]{\includegraphics[width=12bp]{shield_#1.png}}
\usepackage{calc} % \heightof
\newcommand{\blasonsmall}[1]{\includegraphics[height=\totalheightof{Ap}]{shield_#1}}

\newcommand{\SDCF}{\xnameref{chSpecific:Catholic Faith}\xspace}
\newcommand{\Barbaresques}{\xnameref{chSpecific:Barbaresques}\xspace}

% diagonal strike adapted from
...
\newcommand{\cnbouvet}{\cntext{白晋}}
\newcommand{\cnbouvetcourtesy}{\cntext{明远}}
