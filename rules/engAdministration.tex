...
Chapters to keep things clearer. Especially, the Logistic Chapter also
describes a lot of military concepts.
...
(see \ruleref{chAdministration:Technology Improvement}).
...
\begin{exemple}[Simple loan (cont.): complete refund]
  ...
  entirely refunded and no more interests shall be payed. Thus, \FRA erases
...
\bparag See the access limitations in \ref{chAdministration:Inland advance} and
\ref{chAdministration:Native empires} for restriction on the provinces that may be
targeted.
% \bparag See the access limitations in \ruleref{chAdministration:Limited Access}.
...
\aparag[Critical failure]\label{chAdministration:TP:Critical failure} A result of
...
that is one may learn both from it allies and it enemies.
