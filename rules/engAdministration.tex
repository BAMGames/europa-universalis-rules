...
% following modifiers:
\bparag See the access limitations in \ruleref{chAdministration:Limited Access} for
...
levels.
\bparag See \ruleref{chAdministration:Trade Competition Mandatory} if two fleets are
...
\aparag\label{chAdministration:Colony:Critical failure} An unmodified result of 1 or
