...
either own a province (or have a \COL or \TP) adjacent to the sea (even
without port), the \CCs{Grand Orient} or the \CCs{Mediterrannee}.
...
it was really lagging behind) in which case it pay the conversion cost that
many time.
