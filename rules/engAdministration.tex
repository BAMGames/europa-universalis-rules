...
\aparag[Administrative limits] \label{chAdministration:Administrative Limits} Each
...
\begin{designnote}
  ...
  % (jym) MNU objective does not exist any more.
...
% \aparag[Limits of Domestic operations]\label{chAdministration:Domestic Limits}
