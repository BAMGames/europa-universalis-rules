...
\begin{designnote}[Expenses] This chapter and the following one describe
  mainly all the logistics (maintenance and purchase of new forces), country
  management and development operations. All of these form the administrative
  phase, that may be cut into three main sections: administrative operations,
  automatic actions and logistics. Administration and Logistic are conducted
  independently and simultaneously by all players while automatic actions
  resolve the conflicts that arise from the new state (incompatible placements
  of new colonies, monopolies, etc.) Most of the parameters of administrative
  operations were explained in~\ref{chapter:ThePowers}, and serve mostly
  in~\ref{chapter:Incomes} and theses chapters. The nature of military troops
  is also explained before the logistics details.
...
\begin{exemple}[Simple loan]
  At turn 1, \FRA contracts an International Loan of 100\ducats. Thus, it
  writes 100\ducats in \lignebudget{New International loan} of turn 1 (new
  money), 100\ducats in \lignebudget{International loans refunds} of turn 4
  (refund in 3 turns) and 10\ducats in \lignebudget{International loans
    interests} of turns 2, 3 and 4.

  At turn 2, \FRA decides to refund 40\ducats of this loan. Thus, it write 40
  in \lignebudget{International loans refunds} of turn 2 and decrease
  \lignebudget{International loans refunds} of turn 4 by the same amount
  ...
  writes 60 in \lignebudget{International loans refunds} of turn 3 and
  decrease \lignebudget{International loans refunds} of turn 4 by the same
...
\begin{exemple}[Double loan]
  ...
  \begin{itemize}
  \item \lignebudget{International loans refunds}: 50\ducats at turn 4 and
    60\ducats at turn 5 (mandatory refunds of the two loans).
  \item \lignebudget{International loans interests}: 5\ducats at turn 2
  ...
  Thus, \POL set \lignebudget{International loans refunds} of turn 5 to
  ...
  have to be removed. Thus, \POL remove 6 from \lignebudget{International
    loans interests} of turns 4 and 5 (between now and the term of the loan).
\end{exemple}
...
\begin{exemple}
  ...
  2 (as explained in ~\ref{chAdministration:Administration Minor}). Thus, the column
