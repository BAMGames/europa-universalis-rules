...
\event{pVI:WoQA}{VI-t}{War of the Quadruple Alliance}{1}{PBNotEvenWritten}
\history{1718-1720}
\begin{todo}
  \SPA vs \paysNaples.
\end{todo}

\event{pVI:Alberoni}{VI-u}{Alberoni}{1}{PBNotEvenWritten}
\history{1711-1719}
\begin{todo}
...
\event{pVI:Delition Ottoman}{VI-v}{Delition of the Ottoman Empire}{1}{PBNotEvenWritten}
\begin{todo}
