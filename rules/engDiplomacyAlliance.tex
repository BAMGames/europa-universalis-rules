...
amounts of money can also be transferred %in informal agreements (see
% \ruleref{chDiplo:Informal Money Transfer}) or
...
Religion. \HOL, after being recognised by \SPA (see \eventref{pIII:Dutch
  Revolt}), may also lend money to any \MAJ with no penalty for Religion.
...
\eventref{pIII:Amsterdam Stock Exchange} and \eventref{pIV:London Stock
  Exchange}) can transfer up to 250 \ducats per Loan.
...
denied as foreign
trade.% (in addition to this player's Vassals, its enemies in
% wars and
%% Muf ? phrase/parenthese pas finie...
% certes. Laissons donc ainsi.
