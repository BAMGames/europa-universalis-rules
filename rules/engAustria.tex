\sectionJ{\anchorpaysmajeur{Autriche} and Habsburg Empire}{\blasonJ{habsbourg}}\label{chSpecific:Austria}
...
\aparag[Access to \HAB] 
When \SPA is the Emperor, he gains free access to all \pays{Habsbourg}
...
After \eventrefshort{pI:Habsburg Hungary} or \eventrefshort{pI:Fall Hungary}, 
apply the following.
\bparag \HAB has a permanent \CB against \TUR as long as \TUR own a
province initially in \pays{Hongrie}.
\bparag If both \pays{Habsbourg} (under this provision) and \SPA declares a war 
...
\ARMY\facemoins if \pays{Hongrie} was split due to \eventref{pI:Fall
 ...
 (the best applies).
\bparag \HAB uses the leaders of \pays{Hongrie} as if its own.
\HAB may use the counters of \pays{Hongrie} if it owns at least
7 provinces of \pays{Hongrie}, and only one \ARMY and half of the \LD if
...
%\subsubsection{People of Notice}
%\aparag[Montecuccoli] He is a general \leaderwithdata{Montecuccoli}. He
%gives the benefice of a Military Revolution to \hab or \AUS for \TMAN,
%when he comes in play.
% Muf. Devient inutile puisque le passage en Maneuvre est mis dans
% l'event from Montecuccoli to Prinz Eugen.
%
