...
\aparag[\anchorville{Mecca} and the \anchorconstruction{Kaaba}]
\bparag \construction{Kaaba} is placed in \province{Nedj W} at the
...
\begin{histoire}
  ...
  sacred mosque of \strongbazar{Masjid al-Haram} in \villeMecca. Its
  cornerstone is the \strongbazar{Black Stone}, supposed to have fallen from
...
be \TMUS.  The malus to improve \terme{Land Technology} is applied
only if it is \TMUS or better. The \terme{Naval Technology} \TBAT is
now accessible.
...
\aparag[\anchorconstruction{Malta}.] \TUR may build an arsenal in
...
following minors: \pays{Hongrie}, \pays{damas}, \pays{Egypte},
\pays{Genes} and \pays{Chevaliers}, \pays{Perse}.
...
\aparag[\anchormonarque{Selim I}.] If \monarque{Bayezid II} dies
during \period{I}, his successor is \monarque{Selim I}. If there had
been a dynastic crisis at that time, it is nullified. \monarque{Selim
  I} has values 7/5/8 and is due to last 3 turns.
