...
\newcommand{\EU@objNoRUSBaltic}[2][]{% M? full
  \EUobjective{#1}{\paysmajeurRussie not adjacent to
    \regionBaltique}{}{\EU@objhalf{#2}}{#2}{\paysmajeurRussie does not own any
...
% Seem to be always with the same number of provinces...
  \EUobjective{#1}{\paysmajeurSuede contained}{}{\EU@objhalf{#2}}{#2}{%
    ...
    \regionBaltique (\regionSuede and \regionFinlande excepted) owned by
    \paysmajeurSuede; 3 or less: success; 4: half-success; 5 or more:
    failure}}%
...
\newcommand{\EU@objLouisXIV}[3][]{% M? half full
  \EUobjective{}{Louis XIV's wars}{war}{#3}{#2}{For each victory
...
\newcommand{\EU@objSpanishWorld}[2][]{% M? full
  \EUobjective{#1}{Spanish World}{}{\EU@objhalf{#2}}{#2}{No non-Spanish \COL
    in \continent{South America}, \granderegionFlorida and \continentCaraibes;
...
\newcommand{\EU@objValMol}[2][]{% M? both
  \EUobjective{#1}{\paysValachie/\paysMoldavie}{country}{\EU@objhalf{#2}}{#2}{%
    Each of \paysValachie or \paysMoldavie which is either \VASSAL of
    \EUcurrmaj or conquered (all of its provinces are owned by
...
\EU@objEachCOL[in \continentBrazil]{}{10}{40}%
%
\EUcurrentperiod{V}%
\EU@objTradeCentre[M]{Atlantic}{40}%
...
\EU@objAmericaHOL{15}{45}%
\EU@objEachCOLTP[in \continentIndia]{}{15}{50}%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% (jcd) Should be M ?
% (jym) Probably not.
\EU@objEachCOLTP[in \continentAmerica]{}{10}{30}%
...
\EU@objEachCOL[in \granderegionAlaska]{}{10}{30}%
%
\EUcurrentperiod{VII}%
...
\EUobjective{}{Few nat\EUAbbr{ional} prov\EUAbbr{inces} lost}{}{20}{40}{%
  ...
  0: full sucess; 1: half-success;2 or more: failure. Only checked provinces
...
%
\EUcurrentperiod{II}%
\EU@objCountryDestroyed{40}{Hongrie}{\paysHongrie Destroyed}%
...
\EUobjective{}{Peace in \payshongrie}{}{}{35}{%
  No more than two turns of war between \AUSaus and \TUR}%
...
\EUobjective{}{\paysgeorgie/\paysperse}{prov\EUAbbr{ince}-3}{15}{---}{%
...
\EU@objEachProvinceListAbove[M]{\provinceChypre, \provinceKreta,
  ...
  \provinceRhodos}{20}{50}{Non-\TUR islands}{2}
...
\EUobjective{M}{\TP in \paysChine and \paysJapon}{}{}{50}{%
  \paysmajeurPortugal has a \TP both in \paysChine and \paysJapon}%
\EU@objMarocVassal{10}{40}%
\EU@objMarocAnnexion{30}%
