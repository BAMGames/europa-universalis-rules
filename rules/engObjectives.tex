...
\newcommand{\EU@objBigAustria}{\EU@objEachProvinceOtherText{\paysmajeurAutriche}
  above 11}%
...
\newcommand{\EU@objEastMalacca}{Christian non-Dutch \TP east of
  ...
  \continentIndochina)}%
\newcommand{\EU@objAmericaHOL}{\EU@objEachItemText[\continentAmerica
  (\continentBrazil excepted)]{\COL}}%
...
\EU@objEachCOLTP{Colonisation}{7}{40} \EUobjective{M}{Only
  \ville{Saint-Petersbourg} lost}{}%
