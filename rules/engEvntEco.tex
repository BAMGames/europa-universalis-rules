...
counters on their corrupted side). This Pasha is chosen by The Sole defender
of the Catholic Faith (or \MAJHAB is there is none). This pasha must be in
owned Turkish provinces; if none are available, displace the newly corrupted
pashas in any province (except the capital).
