...
\aparag[Colonisation.] A \LeaderMis gives a modifier equal to his
modifier (+1 to +3) to any \TP/\COL placement attempt in the province he is if
the settlement is not \Faceplus (either no settlement or à \Facemoins one).
