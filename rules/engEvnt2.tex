% -*- mode: LaTeX; -*-
\definechapterbackground{Political Events of Period II}{CranachLuther}
\chapter{Political Events of Period II}
%\section{Period II}
\label{events:pII}
...
\begin{eventstable}[Period II events table]
  ...
  \begin{tabular}{|l|*{6}{c}|l|}
    ...
    1 & 2  & 1  & 10  & 13  & 1  & 1   & \\
    2 & 3  & R2 & 11  & R14 & 2  & R8  & \textbullet~1--2:\\
    3 & R4 & 3  & 12  & R15 & R3 & R2  & +1 then\\
    4 & 5  & 4  & 15  & 16  & R4 & 11  & \periodref{I}\\
    5 & 6  & 8  & 16  & 17  & R5 & 12  & \\
    6 & 7  & 9  & 17  & R18 & 7  & 13  & \\
    7 & 8  & 11 & R18 & R21 & R8 & R19 & \textbullet~3--10:\\
    8 & 10 & 12 & R8  & 1   & R9 & R21 & \periodref{I}\\
    9 & R9 & 21 & R21 & 19  & 14 & R20 & \\ \hline
    10 & \multicolumn{7}{l|}{Roll in \periodref{III}} \\ \hline
  \end{tabular}
\end{eventstable}
...
\condition{Takes place when rolled for, or when \monarque{Henry VIII}
  dies. May not happen before \monarque{Henry VIII}.}
...
\aparag[Lady Jane Grey] \ENG is forced to be \PROTPUR.  If it has changed,
...
of the League is called a war against the League; it is a \terme{war of
  Religion} (so external intervention is constrained).
...
discoveries of \seazoneMascate and \seazoneKutch
...
\seazoneMascate and \seazoneKutch.  If the \CB is used, \TUR gains a Treaty
with \paysOman or/and \paysAden.
...
\event{pII:Crusade}{II-B}{Call for Crusade}{*}{JymMod}
% google battle:
...
its stack with at least 3\LD or \NWD (or 6\NGD) belonging to it as a ``main
crusading stack''.
...
\bparag All his troops initially in the main crusading stack moved this round
and end up closer to the territory of \TUR or its allies.
