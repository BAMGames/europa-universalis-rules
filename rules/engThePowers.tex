...
%
% old -> new "Anglican" -> "Protestant/Anglican" (or "Anglican") "Protestant
% (or Anglican)" (sometimes "Protestant") -> Protestant "Protestant (not
% Anglican)" -> "Protestant/Puritan" (or "Puritan").
\aparag There are four Protestant standings: \terme{Anglican} and
\terme{Puritan} (available only for \ANG) ; \terme{Strictly protestant} and
\terme{Tolerant} (available only for \SUE).
...
\monarquePatkul, \ministrePotemkine, \ministreOxenstierna, \ministreKoprulu,
...
\STAB as indicated in~\ruleref{chPeace:Revolts Stability}.
...
see~\ruleref{chPeace:Extension Revolts}.
...
benevolent monarch, see~\ruleref{chPeace:ExecutionMonarchByRevolts}.
...
\bparag See~\ruleref{chPeace:CorsairAttack}.
