...
\aparag The monarch is \monarque{Henry VII} (7/5/6), he is scheduled to die at
the beginning of turn 5. The next monarch will be \monarque{Henry VIII}. The
\STAB is +1, and \ANG is \terme{Catholic}.
...
\aparag The monarch is \monarque{Charles VIII} (5/7/9), he is scheduled to die
at the beginning of turn 4. The \STAB is +3, and \FRA is \terme{Catholic}.
...
\aparag The monarch is \monarque{Isabel and Ferdinand} (6/7/6), they are
...
\aparag The monarch is \monarque{John and Alexander} (4/5/4), they are
...
\aparag The monarch is \monarque{Joao II} (8/6/7), he is scheduled to die at
the beginning of turn 2. The next monarch will be \monarque{Manuel I}. The
\STAB is +3, and \POR is \terme{Catholic}.
...
\bparag[Already placed mission]: One mission (\construction{Kongo}) in a
...
\seazoneGambie, \seazoneGuinee, \seazoneAngola, \seazone{Tempetes}.
...
\aparag The monarch is \monarque{Ivan III} (6/7/8), he is scheduled to die at
the beginning of turn 4. The \STAB is +3, and \RUS is \terme{Orthodox}.
...
\aparag The monarch is \monarque{Bayezid II} (7/5/6), he is scheduled to die
at the beginning of turn 7 and [BLP] he suffers from \terme{Fragile
  Health}. The next monarch will be either \monarque{Selim I} (if during
period \period{I}) or \monarqueSuleyman (if at the beginning of turn 7). The \STAB is
+2, and \TUR is \terme{Sunni}.
...
\provinceCaffa.
\bparag[Already place mission] \construction{Kaaba} is in \province{Nedj
  W} (\villeMecca).
...
\DTI is 3.
\bparag Initial treasury is 400\ducats.
\bparag \TradeFLEET level 2 in \ctz{Turquie}, level 2 in \stz{Noire W}.
...
the beginning of turn 3. The \STAB is +3, and \VEN is \terme{Catholic}.
...
in \stz{Ionienne} and level 3 in \stz{Noire W}. \VEN owns the
\CCs{Mediterranee}.
...
\bparag \paysgenes has a \TradeFLEET lv. 3 in \stz{Lion}, lv. 4 in
\ctz{Espagne} and lv. 2 in \stz{Ionienne}.
\bparag \paysoman has a \TradeFLEET lv. 2 in \stz{Arabie}.
\bparag \paysaden has a \TradeFLEET lv. 2 in \stz{Indien}.
\bparag \paysgujarat has a \TradeFLEET lv. 4 in \stz{Arabie}, lv. 2 in
\stz{Indien} and lv. 1 in \stz{Aiguilles}. The \CCs{Indian} is in \villeDiu.
\bparag \paysjapon has a \TradeFLEET lv. 3 in \stz{Chine}.
\bparag \payschine has a \TradeFLEET lv. 3 in \stz{Chine}.
...
\RES{Metal} on side\faceplus in \provinceJamtland, \FTI is 2 and \DTI is
...
% LocalWords: Preussen Tras Montes Praya Cabo malus Guinee
