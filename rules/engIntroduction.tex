...
usually require 2 to 4 hours to play. Hence a \terme{great campaign}, the way
...
\ref{chapter:Inter} describe the core rules. Most chapter corresponds to one
...
Some of us are also present on other gaming forums such as the BoardGameGeek
forums, ConsimWorld (\url{http://talk.consimworld.com/}, in English) or
Strategikon (\url{http://www.strategikon.info/phpBB3/}, in French). This is
however not the most reliable way to reach us.
