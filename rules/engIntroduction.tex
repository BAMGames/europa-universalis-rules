...
%\section*{Overall features of the game [intro]}

% RaW: [intro]
%\begin{todo}
%  [intro] needs to be rewritten completely due to the massive changes and must
%  be rewritten only when everything else is (eg reference to scenarios,
%  \ldots)
%\end{todo}
...
The counters are not pre-cutted. Thus, you will need to print them (22 pages,
