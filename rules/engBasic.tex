...
% \aparag The movement cost is doubled in this area
% (see~\ruleref{chMilitary:Movement:Wasteland}), the building of fortresses is
% restricted (see~\ruleref{chExpenses:Fortresses Wasteland}).
% \bparag Units of the waste-native countries: \RUS, \pays{pskov},
% \pays{ryazan}, \pays{cosaquesdon}, \pays{Kazan}, \pays{Astrakhan},
% \pays{Steppes}, \pays{crimee}, \pays{ukraine}, \pays{Lithuanie} (only if
% \POL chose an orthodox attitude, see \ruleref{chSpecific:Poland:Orthodoxy})
% are not subject to the movement penalty.
% \bparag\label{chBasics:End Wasteland} Both restrictions end with the
% finishing of the funation of \ville{Saint-Petersbourg}, or at the end
% of \eventref{pVI:Great Northern War}, whichever is first.


\subsubsection{Cold Area}\label{chBasics:Cold Area}
\aparag[in Europe]% All of the Swedish peninsula except \province{Skane} and
% the territories north of \province{Livonija}, \province{Neva},
% \province{Novgorod}, \province{Moskva}, \province{Vyatka} and
% \province{Ural}
All provinces within a whitish line on the North of the map form the European
cold area.
% This is the cold area of Europe, and the movement is doubled there for the
% purpose of supply only.
% \bparag The cost is not doubled in the national territory, plus the
% provinces of \region{Norvege} for \pays{danemark} and the provinces of
% \region{Finlande} for \pays{suede} (or \SUE).
...
\bparag \textbf{Exception:} \REVOLT detachments and armies, as well as
\pays{pirates} privateers are in unlimited amount.
...
\item[\anchorcontinent{Africa}] The whole continent of Africa, including the
  islands of \granderegion{Sainte-Helene}, \granderegion{Cabo Verde},
  \granderegion{Madagascar}, \granderegion{Mascareignes} and
  \granderegion{Seychelles}, but excluding the places of \continent{Middle
    East}.
...
\item[\anchorcontinent{Brazil}] It comprises the following areas:
  \granderegion{Belem}, \granderegion{Recife}, \granderegion{Rio}.
...
\item[\anchorcontinent{North America}] It contains all the inland areas of
  ...
  (excluded).
\item[\anchorcontinent{Caraibes}] It is composed of \granderegion{Haiti},
  \granderegion{Cuba}, \granderegion{Antilles} and \granderegion{Florida}.
\item[\anchorcontinent{Extreme Orient}] It is the union of the following
  areas: \granderegion{Japan}, \granderegion{Formose},
...
\item[\anchorcontinent{India}] It is the Indian sub-continent, magnified on
  the map, and includes \granderegion{Ceylan}.
...
\item[\anchorcontinent{Siberia}] It is the union of all northern territories
  from \granderegion{Siberie} to \granderegion{Amour} and
  \granderegion{Kamchatka}.
\item[\anchorcontinent{Asia}] It is composed of Indochina, Oceania,
  \continent{India}, \continent{Middle East} and \continent{Extreme Orient}
