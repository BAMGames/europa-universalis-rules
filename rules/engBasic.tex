...
\begin{deflist}
\item[\anchorregion{Autriche}] contains all the national provinces of
  \paysmajeur{Autriche}, marked with a \blasonsmall{habsbourg}, namely:
  \province{Tirol}, \province{Salzburg}, \province{Osterreich},
  \province{Steiermark}, \province{Karnten}, \province{Slovenija}.
...
\item[\anchorregion{Mediterranee}] contains all the sea zones of the
  ...
  navigate it.
\item[\anchorregion{Norvege}] contains the provinces marked with a blurre
...
\item[\anchorregion{Perse}] contains the four easternmost European provinces
  of \pays{perse}, outlined in black, namely: \province{Pars},
