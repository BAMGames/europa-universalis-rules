...
the correct ownership counter. If there is a fortress in the province, the new
...
same level).
\bparag \COL and \TP given as territorial concession also change
...
diplomatic counter at the right position on the diplomatic track, even if the
minor is at war.
...
\bparag Exception: \Presidios do not change ownership.
...
\bparag Unless this is a white peace, all temporary \CB from all belligerent
...
\begin{exemple}[Peace with minors and \STAB]
  At turn 5, \TUR attacks \paysDamas, a minor. If it sign peace at the end of
  turn 5, it does not gain \STAB as this is a minor.
  ...
  now completely at peace, it gain 1 \STAB.
\end{exemple}
