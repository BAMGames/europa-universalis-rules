...
\begin{exemple}[Military situation]
  ...
  \leader{D Rantzau} is nonetheless killed in an unsuccessful assault (at
  ...
  a not too bad situation (especially with \leader{D Rantzau} dead), \SUE
...
\begin{exemple}[\STAB adjustment: Thirty years war]
  ...
  At turn 27, the war degenerates in \ref{pIV:TYW} and both \HIS and \HOL
  enter the war. At the end of the turn, \HIS and \HOL both lose 1 \STAB, as
  they have been at war for one turn, while \AUS loses 2 \STAB, as it has been
  at war for two turns.
...
ones are contracted, even if not represented in game).
