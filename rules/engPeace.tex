...
\aparag[Stability] A country may attempt to improve his Stability, but this is
never mandatory. As many action, Stability improvement requires an investment
and is resolved by a die roll. Beware that in some situation the result must
be negative and can be forfeited once the die has been rolled.

\aparag[Investment] Each player wanting to improve that Stability of his
country first choose and investment and write it in \lignebudget{Stability
  improvement}. As for administrative action, higher investments give bonuses
to the roll.
\bparag The investment are:
\begin{modlist}
  \item Basic Investment: 30 \ducats
  \item Medium (+2 to the die-roll): 50 \ducats
  \item Strong (+5 to the die-roll): 100 \ducats
\end{modlist}
...
\begin{modlist}
  ...
  \item[-5] if an enemy \ARMY counter is in an owned national province and
    controls the province city (not applicable during a Religious/Civil War,
    do not count revolt and rebel troops).
