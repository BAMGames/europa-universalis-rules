...
the enemies.
\bparag In case of alliance, take the mean \STAB of all member of the
...
\begin{exemple}[Modified Peace Differential]
  ...
  ago). Both side thus controls as many enemy province and the PD is not
  modified.
\end{exemple}
...
\begin{exemple}[PD and minors]
  If \paysCrimee was at war allied to \TUR and \RUS controls \provinceHacibey,
  this province has to be taken into account for modified peace differential
  in any peace that include \TUR.
\end{exemple}
...
\begin{exemple}[Rounding PD]
  ...
  third in favour of \RUS, rounded to +1 in favour of \RUS.
