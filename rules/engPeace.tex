...
\aparag Inflation increases quickly as the gold and silver flow from
\continentAmerica becomes high and regular.
...
\aparag[Inflation]
\bparag Each country loses a amount of money which is the maximum between:
\begin{modlist}
\item Its Minimal inflation
\item[AND] its Inflation value applied to the absolute value of its \RT (drop
