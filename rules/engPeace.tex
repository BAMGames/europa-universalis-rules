...
\begin{playtip}
  Bankruptcies should be noted by a small \textetoile in \lignebudget{Gross
    income A} for the turn where they affect the Exchequer test.
\end{playtip}
...
\begin{playtip}
  ...
  it is sometimes more fluent to start computing your budget and then
  sometimes come back to looking at international loans. Since there is no new
  knowledge gained between the Exchequer test and the Budget, this does not
  change anything.
...
\begin{designnote}
  You cannot spend additional money from prestige (it must be non-negative).
...
\bparag Copy this number in \lignbudget{New National loans}.
