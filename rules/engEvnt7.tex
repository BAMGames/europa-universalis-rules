...
\section{Period VII}\label{events:pVII}
...
re-roll:
\bparag \ref{pVII:SYW:French Indian War}.
...
started).
\bparag Beginning of \xnameref{pVII:Batavian Revolution}.
...
\begin{digressions}[Effects of the Revolution]
  ...
  (of \pays{revolutionnaires}) belong to the same country for all purpose of
  leadership.
  ...
  \bparag All leaders of \FRA are dismissed. \FRA now uses the leaders
  of \pays{revolutionnaires} (excluding \leaderBonaparte).
...
% (Jym), Placeholder, potential veto
