...
characteristics mentioned in the appendix (\ruleref{ch10:Habsburg vassal
  kingdoms}).
...
\aparag[The Spanish Tax] \label{chSpecific:Spain:Dutch Tax} The Spanish Holland
is the set of all provinces belonging to \SPA in the limits of the
national territory of \paysmajeur{Hollande}
...
for a maximum of 100\ducats, to be added in \lignebudget{Special
  income}.
\bparag These provinces are counted as foreign for \ruleref{chIncomes:Trade
  Income}.
...
\ruleref{chPeace:Peace:Independence Revolt}). This may lead to applying the
effects of \eventref{pIII:Dutch Revolt} before period III.
...
active.
\bparag If Spain is the \terme{Sole defender of the Catholic Faith} and
has not proceeded to the expulsion by the end of period III, it loses
75\VP.
\\
