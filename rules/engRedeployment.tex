...
\begin{exemple}[Naval redeployment]
  ...
  its closest redeployment possibility is by sea (3\MP) and then to
  \provinceHinterpommern (4\MP due to swamp and river). Redeployment by sea,
  however, does not takes precedence over redeployment by land and \SUE can
  freely choose any of the possibility (but may not split its stack).
\end{exemple}
