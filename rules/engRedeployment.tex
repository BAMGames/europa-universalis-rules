...
current price).
\bparag \pays{pirates} receive no income for looting.
...
Natives attack) nor protection by sacrificing forces in the province (opposite
to attacks at sea).
...
\bparag \PILLAGE placed by land raid are considered simultaneous with military
looting (\ref{chRedep:Looting}).
...
\section{Extension of Revolts}\label{chRedep:Revolts}
