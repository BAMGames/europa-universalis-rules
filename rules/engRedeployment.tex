...
\begin{exemple}
  ...
  village to burn and peasants to kill. A new \PILLAGE\Faceplus is put in
  ...
  be especially useful it does not intend to continue the siege as the
  ...
  may not burn it as it does not controls is. If looting it, \HOL will only
  gain 1\ducats (regular income of a \TP\Facemoins). For such a small amount,
  it choose to leave it, hoping to take it later. On the other hand, the
  \TP\Faceplus is controlled and \HOL chooses to burn it (rather than looting
  for 2\ducats). The province is now empty and open for attempt of Dutch \TP
