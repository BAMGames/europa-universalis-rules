...
\begin{exemple}
  During peiord \period{II}, \leaderwithdata{Barbaros2} sails out of
  ...
  (targeted sides) +2 (\TradeFLEET\facemoins in defence) +5 (\terme{manoeuvre}
  of \leader{A Doria}) -3 (years at sea) -5 (\terme{manoeuvre} of
  \leader{Barbaros2}) = +5.
