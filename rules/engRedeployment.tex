...
\begin{exemple}[Bantu raids]
  ...
  \item \granderegionNyasa S.: \TP of level 2 of \HOL, no fortress.\\
    ...
    the Bantu has 4.
  \item \granderegionNatal N.: \TP of level 3 of \FRA, fortress of level 1.\\
  ...
  \item \granderegionNyasa S.: the modifier is +2 (troops in defence) +3
    ...
    rolls 7 and loses 3 level of \TP (destroyed) and 2\LD (both killed).
  \item \granderegionNatal N.: the modifier is +1 (fortress in defence) -6 (6
    native \LD) -3 (native \terme{manoeuvre}) = -8. \FRA rolls 6-8 = -2 and
    loses 6 level of \TP (destroyed) and 8\LD or level of fortress
    (destroyed).
  \item \granderegionNatal S.: the modifier is +4 (\LD in defence) +2
    (\terme{manoeuvre}) -1 (native \LD) -5 (\terme{manoeuvre}) +6 (rout) =
    +6. \ANG rolls 6+6 = 12 and loses 1 level of \TP (1 stays) and 1\LD (3
    remain).
  \end{itemize}
