...
\event{pIII:VOC}{III-1 (2)}{Creation of the VOC}{1}{RistoMod}
...
\event{pIII:East Indian Company}{III-3 (1)}{Creation of the East Indian
  Company}{1}{Risto}
...
\monarque{Charles IX}, with values 8/6/6 (but not a general).  Exception: if
\monarque{Gustave Adolphe} was to be the new monarch due to another event, use
\monarque{Gustave Adolphe}.
...
\aparag The Russian leader \leaderKurbskii is withdrawn from game as long as
