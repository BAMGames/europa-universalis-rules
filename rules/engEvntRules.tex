...
\definechapterbackground{Events}{IngresDeathOfDaVinci}
...
\aparag[Fragile health] If the result is 10, the new monarch will have
\terme{fragile health}.
...
named \pays{pirates} \LeaderP is alive) or if~\ref{eco:Piracy} was
...
indicated, in order.
\bparag Everywhere: \stz{Caraibes}, \stz{Amerique}, \stz{Indien},
\stz{Arabie}, \stz{Guinee}, \stz{Recife}, \stz{Perou}, \stz{Chine},
\stz{Patagonie}, \stz{Aiguilles}, \stz{Canarias}.
\bparag America: \stz{Caraibes}, \stz{Amerique}, \stz{Guinee},
\stz{Recife}, \stz{Patagonie}, \stz{Aiguilles}, \stz{Canarias}.
\bparag Asia: \stz{Indien}, \stz{Arabie}, \stz{Perou}, \stz{Chine},
\stz{Canarias}.
% It's not a bug, it's a feature.
\bparag Yes, \stz{Canarias} is both for piracy in America and in
Asia. Yes \stz{Guinee} and \stz{Aiguilles} are only for America. Yes,
...
\aparag Some famous pirates appear as named \pays{pirates} \LeaderP and
...
\aparag[Revolts] If the result is 'R' followed by a number, a \RD
...
and~\ruleref{chEvents:diplomacy}. Mark off the box.
...
\aparag[Troubled religion] When a Diplomacy event occurs, a first die
...
\aparag[Troubled minors] Then, for each Diplomacy event, roll for a
