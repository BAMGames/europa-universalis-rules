...
* TODO Conquêtes TUR
** TODO TUR passe à 1G de base, sauf en pIII où il en a 2 (actuellement, 4).
** TODO Les pachas ne peuvent pas commander de grosse pile.
** TODO La réforme M-2 ajoute 2G à la limite de TUR.
** TODO effet "mort d'un pacha" :
   ...
   de 5 ou 7.
** TODO Supprimer la corruption de pachas sur E-7 et la mettre sur 6 au jet
   de survie TUR.
