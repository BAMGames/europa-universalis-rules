...
* TODO Fleet in being
** Changer les limites minimum d'amiraux en pV/VI/VII comme suit :
   ANG : 3/4/5 (au lieu de 2/2/2)
   FRA : 2/3/4 (au lieu de 2/2/2)
   HOL : 2/3/3 (au lieu de 1/1/1)
   HIS : 2/2/3 (au lieu de 2/1/1)
** Ajouter *en pV+** les amiraux non-nommés suivants
...
* DONE Chefs immortels (fait)
  - State "DONE"       from ""           [2013-09-23 Mon 12:54]
...
* DONE Vices-rois, Sea hounds, VOC (fait)
  - State "DONE"       from "DONE"       [2013-09-23 Mon 12:54]
  - State "DONE"       from ""           [2013-09-23 Mon 12:54]
...
** Si un E mercenaire nommé est en vie, il est ajouté au pool de
mercenaires pour le tour (donc c'est lui que si il est tiré au hasard).
** J. Cabot devient mercenaire.
** S. Cabot devient mercenaire et est étendu aux T5-13.
** On ajoute les mercenaires suivants :
