...
* TODO Blasons
** TODO blasons effacés AUS/TUR/Transylvanie dans les provinces du partage
  hongrois.
** TODO blasons commerciaux pour les règles "commerciales" :
*** TODO Raguse (TUR/VEN)
*** TODO Caraïbes (HIS/ANG)
*** TODO Galion de Manille (HIS/Chine)
** TODO blasons chinois dans les zones de Nerschinsk.
** TODO blason effacé RUS dans les provinces Saint-Petersburgables ?

** TODO blason effacé Savoie en Dauphiné.
* TODO Occupations
